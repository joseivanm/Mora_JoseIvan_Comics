...
namespace ComicWPF.Models
{
    public interface IComicRepository
    {
        ...
        void EditarStockComic(int editorial, int local, int metodoPago, int clienteId, int? comicId, int empleadoId, int precioCompra, int cantidad, bool rbCliente, string comicNombre, int autor);
